...
```
Figure 1. Histogram of total steps per day, with the calculated means and medians

```{r, echo = FALSE}

  #open PNG device and file, then draw chart
  png(file="figure/figure1.png", width = 480, height = 480, units = "px")
...
##count the number of NA values 
  stepNA <- nrow(x)
  #  cat(stepNA, " observations are NA step values")
...
```{r, echo= TRUE}
  ...
  text(x=stepPoint$interval + 300, y=stepPoint$Mean,"Interval with highest mean number of steps")
  cat("Interval number ", stepPoint$interval, " had the highest mean of ", stepMax)
  
```
Figure 2. The line graph of average steps per interval 

Note:Intervals translate to 5 minute increments using 24:00 clock, eg, 835 = 08:35, 1000 = 10:00, 2350 = 23:50

```{r, echo = FALSE}

  #open PNG device and file, then draw chart and send to figure directory
  png(file="figure/figure2.png")
  plot(x=DFResultInt$interval, y=DFResultInt$Mean, type = "l", xlab = " ", ylab = "Average Steps per Interval")
...
```{r, echo= FALSE} 
  ...
  #open PNG device and name file, then draw plot
  png(file="figure/figure3.png")
