...
##calculate the mean and median of daily steps totals across the time perios
  stepMedian <-median(DFResultDate$SUM) 
  stepMean <-mean(DFResultDate$SUM) 
 
```

Figure 1. Histogram of total steps by date, with the calculated means and medians
...
```{r, echo= TRUE}
  ...
  text(x=stepPoint$interval + 5, y=stepPoint$Mean,"Interval with highest mean number of steps")
